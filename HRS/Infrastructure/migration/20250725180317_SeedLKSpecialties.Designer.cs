...
namespace HRS.Infrastructure.migration
{
    ...
    [Migration("20250725180317_SeedLKSpecialties")]
    partial class SeedLKSpecialties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRS.Models.Entities.LK_Specialties", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 7, 25, 21, 3, 17, 150, DateTimeKind.Local).AddTicks(1124),
                            Description = "Heart..",
                            SpecialtyCode = "CARD",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 7, 25, 21, 3, 17, 150, DateTimeKind.Local).AddTicks(1148),
                            Description = "Brain ..",
                            SpecialtyCode = "NEUR",
            ...
            modelBuilder.Entity("HRS.Models.Entities.lK_UserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 7, 25, 21, 3, 17, 150, DateTimeKind.Local).AddTicks(1373),
                            Status = true,
                            UserTypeName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 7, 25, 21, 3, 17, 150, DateTimeKind.Local).AddTicks(1376),
                            Status = true,
                            UserTypeName = "Doctor"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 7, 25, 21, 3, 17, 150, DateTimeKind.Local).AddTicks(1378),
                            Status = true,
