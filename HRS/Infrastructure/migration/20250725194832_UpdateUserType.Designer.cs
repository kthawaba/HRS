...
namespace HRS.Infrastructure.migration
{
    ...
    [Migration("20250725194832_UpdateUserType")]
            ...
            modelBuilder.Entity("HRS.Models.Entities.LK_Specialties", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 7, 25, 22, 48, 32, 231, DateTimeKind.Local).AddTicks(515),
                            Description = "Heart..",
                            SpecialtyCode = "CARD",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 7, 25, 22, 48, 32, 231, DateTimeKind.Local).AddTicks(529),
                            Description = "Brain ..",
                            SpecialtyCode = "NEUR",
            ...
            modelBuilder.Entity("HRS.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 7, 25, 19, 48, 32, 231, DateTimeKind.Utc).AddTicks(371),
                            Mobile = "0507319204",
                            Name = "System Admin",
                            Status = true,
                            UserName = "admin",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 7, 25, 19, 48, 32, 231, DateTimeKind.Utc).AddTicks(376),
                            Mobile = "0551234567",
                            Name = "Doctor Ali",
                            Status = true,
                            UserName = "draliali",
            ...
            modelBuilder.Entity("HRS.Models.Entities.lK_UserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 7, 25, 22, 48, 32, 231, DateTimeKind.Local).AddTicks(550),
                            Status = true,
                            UserTypeName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 7, 25, 22, 48, 32, 231, DateTimeKind.Local).AddTicks(551),
                            Status = true,
                            UserTypeName = "Doctor"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 7, 25, 22, 48, 32, 231, DateTimeKind.Local).AddTicks(553),
                            Status = true,
